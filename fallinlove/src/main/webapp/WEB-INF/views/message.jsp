...
<!-- ==============================框架内内容========================================= --> 
    ...
    <div class="floatright">
		<!--信件导航 B-->
			...
			<ul class="fn-clear">
				<li class="selected"><a href="http://www.jiayuan.com/msg/" onmousedown="send_jy_pv2('|1015897_2|121261858');">未读信<i class="number">13</i></a></li>
