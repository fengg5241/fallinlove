...
<script type="text/javascript" src="resources/js/head_white.js"></script><script type="text/javascript">
//会员信息对象
window.HEAD_USER = {};
HEAD_USER.uid = 0;
//通用头功能函数对象
