...
// 下面页面*不*进行右下弹出
var checkurl_arr = ["/usercp/center","/usercp/service","priority","brightlist","/usercp/charge","/usercp/loveexpress","/usercp/recommend","/usercp/party","/club", "/clubv2"];
var is_im_show = false;
// 下面页面显示交友活动弹出
//var party_show_arr = ["party.jiayuan.com"];
