...
function checkIdcard(idcard1,showMsg){ 
	var idcard=idcard1;// 对身份证号码做处理。去除头尾空格。
	...
	{ 
		...
		//else alertmsg = "身份证号为空，请输入您的身份证号！";
