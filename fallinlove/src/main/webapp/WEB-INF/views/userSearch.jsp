						...
						<li style="z-index: 1;"><div class="hy_box"
								...
								<div class="search_userHead" onmouseover="show_face_jump(this);"
									...
									<a target="_blank"
										...
										class="search_sameUser">找像她的人</a><a target="_blank"
										href="http://www.jiayuan.com/125431349?fxly=search_v2_index"
										class="openBox" onclick="profileClickCount(true,1)"><img
										src="resources/img/e97ac6fbe_1_avatar_p.jpg"></a>
								</div>
								<div class="user_name">
									<a target="_blank" title="kaka"
										href="http://www.jiayuan.com/125431349?fxly=search_v2_index"
										onclick="profileClickCount(true,1)">kaka</a>
								</div>
								<p class="user_info">30岁 日本</p>
								<p class="zhufang">
									<span>160cm</span>
								</p>
								<div class="zh_btn">
									<a href="javascript:void(0);" class="dzh" foo="0"><span
										class="dzh_text1"
										onclick="show_hello_div_v2('','http://www.jiayuan.com/msg/hello.php?type=20&amp;randomfrom=4&amp;uhash=f8e97ac6fbeb9e54a73ec00ca4290cc9&amp;fxly=search_v2_index');">打招呼</span><span
										class="dzh_text2">已选</span><span class="dzh_text3"
										onclick="dzhCancle(this)">取消</span><span class="dzh_text4"
										onclick="dzhsingleSel(this,'other');">选择她</span></a><a
