        ...
        <ul class="clear JY-filter-1">
            <li class="gray" id="filter-zx">
                ...
                <div class="JY-vip-tip">
                    <div class="t"></div>
                    <div class="m">
                        <h3><a href="javascript:vipIntroTipHide()">close</a>爱一起提示</h3>
                        <div class="m_c">
