                ...
                <ul>
                                ...
                                <a class="menu" id="click_new_id" target="_self" href="http://www.jiayuan.com/usercp/ilooked.php" onmousedown="send_jy_pv2('|1012380_3| ');">
                                		                                    <div class="cp-menu-item-name">我看过谁</div>	                                    <div class="cp-menu-item-number">	                                        <div class="cp-menu-radius fn-right">
                                        	                                            <div id="click_new" class="cp-menu-radius-num" style="">9</div>
                                        </div>
                                    </div>
                                                                    </a>
                            </li>
...
<!--             <div class="item fn-clear"><div class="input-mod"><input class="m-input" value="c5d2000000283f83" admin="1" type="checkbox"></div><div class="avatar-pic"><a href="http://www.jiayuan.com/msg/v6/showmsg_adm.php?msg_id=c5d2000000283f83&amp;box_type=inbox&amp;msg_type=2637699&amp;sort=110" target="_blank" onmousedown="send_jy_pv2('|1015940_17|121261858');"><img src="../resources/img/touxiang_da.jpg"></a></div><div class="con-mod"><div class="specific"><a class="name" href="http://www.jiayuan.com/msg/v6/showmsg_adm.php?msg_id=c5d2000000283f83&amp;box_type=inbox&amp;msg_type=2637699&amp;sort=110" target="_blank" onmousedown="send_jy_pv2('|1015940_19|121261858');">爱一起</a> <span class="icon-box"></span><a class="data" href="http://www.jiayuan.com/msg/v6/showmsg_adm.php?msg_id=c5d2000000283f83&amp;box_type=inbox&amp;msg_type=2637699&amp;sort=110" target="_blank" onmousedown="send_jy_pv2('|1015940_21|121261858');"></a></div><p class="msg-txt"><a href="http://www.jiayuan.com/msg/v6/showmsg_adm.php?msg_id=c5d2000000283f83&amp;box_type=inbox&amp;msg_type=2637699&amp;sort=110" target="_blank" onmousedown="send_jy_pv2('|1015940_23|121261858');">爱一起-网上交友安全指南（务必阅读）</a></p><div class="time"><i></i>09月20日 00:30</div></div><div class="msg-btn gray"><a href="http://www.jiayuan.com/msg/v6/showmsg_adm.php?msg_id=c5d2000000283f83&amp;box_type=inbox&amp;msg_type=2637699&amp;sort=110" target="_blank" onmousedown="send_jy_pv2('|1015940_45|121261858');">查看</a></div></div></div> -->
            ...
            <div id="letter-nodata" class="letter-loading" style="display:none;color:#666">
                暂无信件<br><br>
                                不要错过每一个主动发信给你的人哦，快去阅读他们的信件吧！<a href="http://www.jiayuan.com/msg" onmousedown="send_jy_pv2('|1017689_2|121261858');" style="color:blue">查看未读信&gt;&gt;</a>
                            </div>
...
//                 });
            ...
            function show_result(result){
                ...
                for(var i = 0; i < result.data.length; i++){
					if($page.type!=='star'){
                    	data.status = parseInt(result.data[i].status) != 1 ? '<div class="msg"><a href="'+result.data[i].link+'" target="_blank" onmousedown="send_jy_pv2(\'|1015940_25|121261858\');"><strong class="blue">未回信</strong></a></div>' : '<div class="msg"><a href="'+result.data[i].link+'" target="_blank" onmousedown="send_jy_pv2(\'|1015940_27|121261858\');"><strong>已回信</strong></a></div>';
                        data.button = parseInt(result.data[i].status) != 1 && parseInt(result.data[i].admin) == 0 ? '<div class="msg-btn"><a href="'+result.data[i].link+'" target="_blank" onmousedown="send_jy_pv2(\'|1015940_41|121261858\');">回信</a><a class="refusal" href="javascript:;" onmousedown="send_jy_pv2(\'|1015940_43|121261858\');">礼貌拒绝</a></div>' : '<div class="msg-btn gray"><a href="'+result.data[i].link+'" target="_blank" onmousedown="send_jy_pv2(\'|1015940_45|121261858\');">查看</a></div>';
					} 
					else
					{
						data.status = '<div class="msg"><a href="'+result.data[i].link+'" target="_blank" onmousedown="send_jy_pv2(\'|1015940_25|121261858\');"></div>';
                        data.button =  '<div class="msg-btn gray"><a href="'+result.data[i].link+'" target="_blank" onmousedown="send_jy_pv2(\'|1015940_45|121261858\');">查看</a></div>';
					}
					data.status = parseInt(result.data[i].admin) == 1 ? '' : data.status;
                    ...
                    data.ids = result.data[i].admin == 1 ? result.data[i].msg_id : result.data[i].uid;
                    
                    msg_list += '<div class="item fn-clear"><div class="input-mod"><input type="checkbox" class="m-input" value="'+data.ids+'" admin="'+result.data[i].admin+'" /></div><div class="avatar-pic'+data.photo+'"><a href="'+result.data[i].link+'" target="_blank" onmousedown="send_jy_pv2(\'|1015940_17|121261858\');"><img src="'+result.data[i].avatar+'" />'+data.photo_num+data.online+'</a></div><div class="con-mod"><div class="specific"><a class="name" href="'+result.data[i].link+'" target="_blank" onmousedown="send_jy_pv2(\'|1015940_19|121261858\');">'+result.data[i].nickname+'</a> <span class="icon-box">'+data.icon+'</span><a class="data" href="'+result.data[i].link+'" target="_blank" onmousedown="send_jy_pv2(\'|1015940_21|121261858\');">'+result.data[i].desc+'</a></div><p class="msg-txt"><a href="'+result.data[i].link+'" target="_blank" onmousedown="send_jy_pv2(\'|1015940_23|121261858\');">'+result.data[i].content+'</a></p><div class="time"><i></i>'+result.data[i].time+'</div></div>'+data.status+data.button+'</div>'
                }
            ...
            function show_button(){
                ...
                $('.msg-btn').click(function(){
                    var $tip_txt = $(this).prev().find('span');
                    $tip_txt.removeClass('red');
                    $tip_txt.text('已读');
                });
            ...
            function do_refusal(){
                $('.refusal').click(function(){
                    var $this_obj = $(this);
                    $.ajax({
                        url : '/msg/v6/showmsg_ajax.php?type=refused',
                        data : {'to_uid':$this_obj.parent().parent().find('input').val()},
                        type : 'GET', 
                        success : function(result){
                            if(parseInt(result) == 1){
                                $this_obj.parent().prev().find('strong').removeClass('blue').html('已拒绝');
                                $this_obj.prev().html('查看');
                                $this_obj.prev().parent().addClass('gray');
                                $this_obj.prev().attr('onmousedown', 'send_jy_pv2(\'|1015940_45|121261858\');');
                                $this_obj.remove();
                            }
                            else{
                                JY_Alert('温馨提示', '拒绝失败，请重试。');
                            }
                        }
                    });
                });
    ...
    <div class="midpphoto_body">
    	<ul>
    	        	<li><div><a onclick="send_jy_pv2('usercp_msg|gwxx')" target="_blank" href="http://www.jiayuan.com/123225917?src=personalmatch_msgnewmember_c&amp;cnm=new_mathch&amp;fxly=tj-ymtj-sjxxhytj" class="fuhe"><img src="../resources/img/0bd1609f6_1_avatar_p.jpg" height="90" width="74"></a>
                        </div><a target="_blank" href="http://www.jiayuan.com/123225917?src=personalmatch_msgnewmember_c&amp;cnm=new_mathch&amp;fxly=tj-ymtj-sjxxhytj" class="fuhe"><span>27岁</span><span>其他国家</span></a></li>
                	<li><div><a onclick="send_jy_pv2('usercp_msg|gwxx')" target="_blank" href="http://www.jiayuan.com/122947732?src=personalmatch_msgnewmember_c&amp;cnm=new_mathch&amp;fxly=tj-ymtj-sjxxhytj" class="fuhe"><img src="../resources/img/061206d84_1_avatar_p.jpg" height="90" width="74"></a>
                        </div><a target="_blank" href="http://www.jiayuan.com/122947732?src=personalmatch_msgnewmember_c&amp;cnm=new_mathch&amp;fxly=tj-ymtj-sjxxhytj" class="fuhe"><span>25岁</span><span>其他国家</span></a></li>
                	<li><div><a onclick="send_jy_pv2('usercp_msg|gwxx')" target="_blank" href="http://www.jiayuan.com/123075834?src=personalmatch_msgnewmember_c&amp;cnm=new_mathch&amp;fxly=tj-ymtj-sjxxhytj" class="fuhe"><img src="../resources/img/94cfecbd6_1_avatar_p.jpg" height="90" width="74"></a>
                        </div><a target="_blank" href="http://www.jiayuan.com/123075834?src=personalmatch_msgnewmember_c&amp;cnm=new_mathch&amp;fxly=tj-ymtj-sjxxhytj" class="fuhe"><span>25岁</span><span>其他国家</span></a></li>
                	<li><div><a onclick="send_jy_pv2('usercp_msg|gwxx')" target="_blank" href="http://www.jiayuan.com/123439535?src=personalmatch_msgnewmember_c&amp;cnm=new_mathch&amp;fxly=tj-ymtj-sjxxhytj" class="fuhe"><img src="../resources/img/5b26bf550_1_avatar_p.jpg" height="90" width="74"></a>
                        </div><a target="_blank" href="http://www.jiayuan.com/123439535?src=personalmatch_msgnewmember_c&amp;cnm=new_mathch&amp;fxly=tj-ymtj-sjxxhytj" class="fuhe"><span>30岁</span><span>其他国家</span></a></li>
                	<li><div><a onclick="send_jy_pv2('usercp_msg|gwxx')" target="_blank" href="http://www.jiayuan.com/123227833?src=personalmatch_msgnewmember_c&amp;cnm=new_mathch&amp;fxly=tj-ymtj-sjxxhytj" class="fuhe"><img src="../resources/img/da0b4c3c0_2_avatar_p.jpg" height="90" width="74"></a>
                        </div><a target="_blank" href="http://www.jiayuan.com/123227833?src=personalmatch_msgnewmember_c&amp;cnm=new_mathch&amp;fxly=tj-ymtj-sjxxhytj" class="fuhe"><span>27岁</span><span>其他国家</span></a></li>
                	<li><div><a onclick="send_jy_pv2('usercp_msg|gwxx')" target="_blank" href="http://www.jiayuan.com/124949530?src=personalmatch_msgnewmember_c&amp;cnm=new_mathch&amp;fxly=tj-ymtj-sjxxhytj" class="fuhe"><img src="../resources/img/835099908_1_avatar_p.jpg" height="90" width="74"></a>
                        </div><a target="_blank" href="http://www.jiayuan.com/124949530?src=personalmatch_msgnewmember_c&amp;cnm=new_mathch&amp;fxly=tj-ymtj-sjxxhytj" class="fuhe"><span>24岁</span><span>其他国家</span></a></li>
                	<li><div><a onclick="send_jy_pv2('usercp_msg|gwxx')" target="_blank" href="http://www.jiayuan.com/122976861?src=personalmatch_msgnewmember_c&amp;cnm=new_mathch&amp;fxly=tj-ymtj-sjxxhytj" class="fuhe"><img src="../resources/img/ef15e0755_1_avatar_p.jpg" height="90" width="74"></a>
                        </div><a target="_blank" href="http://www.jiayuan.com/122976861?src=personalmatch_msgnewmember_c&amp;cnm=new_mathch&amp;fxly=tj-ymtj-sjxxhytj" class="fuhe"><span>28岁</span><span>其他国家</span></a></li>
                	<li><div><a onclick="send_jy_pv2('usercp_msg|gwxx')" target="_blank" href="http://www.jiayuan.com/122797481?src=personalmatch_msgnewmember_c&amp;cnm=new_mathch&amp;fxly=tj-ymtj-sjxxhytj" class="fuhe"><img src="../resources/img/b687380b7_1_avatar_p.jpg" height="90" width="74"></a>
                        </div><a target="_blank" href="http://www.jiayuan.com/122797481?src=personalmatch_msgnewmember_c&amp;cnm=new_mathch&amp;fxly=tj-ymtj-sjxxhytj" class="fuhe"><span>22岁</span><span>其他国家</span></a></li>
                	<li><div><a onclick="send_jy_pv2('usercp_msg|gwxx')" target="_blank" href="http://www.jiayuan.com/124507964?src=personalmatch_msgnewmember_c&amp;cnm=new_mathch&amp;fxly=tj-ymtj-sjxxhytj" class="fuhe"><img src="../resources/img/21467838c_1_avatar_p.jpg" height="90" width="74"></a>
                        </div><a target="_blank" href="http://www.jiayuan.com/124507964?src=personalmatch_msgnewmember_c&amp;cnm=new_mathch&amp;fxly=tj-ymtj-sjxxhytj" class="fuhe"><span>24岁</span><span>其他国家</span></a></li>
                	<li><div><a onclick="send_jy_pv2('usercp_msg|gwxx')" target="_blank" href="http://www.jiayuan.com/123436779?src=personalmatch_msgnewmember_c&amp;cnm=new_mathch&amp;fxly=tj-ymtj-sjxxhytj" class="fuhe"><img src="../resources/img/6fc4cad4e_1_avatar_p.jpg" height="90" width="74"></a>
                        </div><a target="_blank" href="http://www.jiayuan.com/123436779?src=personalmatch_msgnewmember_c&amp;cnm=new_mathch&amp;fxly=tj-ymtj-sjxxhytj" class="fuhe"><span>23岁</span><span>其他国家</span></a></li>
                	<li><div><a onclick="send_jy_pv2('usercp_msg|gwxx')" target="_blank" href="http://www.jiayuan.com/123298214?src=personalmatch_msgnewmember_c&amp;cnm=new_mathch&amp;fxly=tj-ymtj-sjxxhytj" class="fuhe"><img src="../resources/img/1048fd623_2_avatar_p.jpg" height="90" width="74"></a>
                        </div><a target="_blank" href="http://www.jiayuan.com/123298214?src=personalmatch_msgnewmember_c&amp;cnm=new_mathch&amp;fxly=tj-ymtj-sjxxhytj" class="fuhe"><span>23岁</span><span>其他国家</span></a></li>
                	<li><div><a onclick="send_jy_pv2('usercp_msg|gwxx')" target="_blank" href="http://www.jiayuan.com/123723004?src=personalmatch_msgnewmember_c&amp;cnm=new_mathch&amp;fxly=tj-ymtj-sjxxhytj" class="fuhe"><img src="../resources/img/298d757d1_2_avatar_p.jpg" height="90" width="74"></a>
                        </div><a target="_blank" href="http://www.jiayuan.com/123723004?src=personalmatch_msgnewmember_c&amp;cnm=new_mathch&amp;fxly=tj-ymtj-sjxxhytj" class="fuhe"><span>25岁</span><span>其他国家</span></a></li>
                </ul>
    </div>
</div></div>
<!-- 	shanf -->
