...
<!-- 标准头 开始--> 
<script type="text/javascript" src="../resources/js/head_red.js"></script><script type="text/javascript" src="../resources/js/head_main.js"></script><script type="text/javascript">
//会员信息对象
window.HEAD_USER = {};
HEAD_USER.uid = 0;
//通用头功能函数对象
