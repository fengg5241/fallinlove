...
<script type="text/javascript" src="../../resources/html/profile_icon.htm"></script>
...
var isIE6 = navigator.userAgent.indexOf("MSIE")>0?(navigator.appVersion.match(/6./i)=="6."?1:0):0;
//获取感兴趣的人
...
function getCommendGift(uid){
	if(uid) ajaxGET('gift_commend','http://www.jiayuan.com/gift_commend.php?uid='+uid);
}
...
function set_agree(_obj){
	...
	var url = 'http://www.jiayuan.com/ajax/set_agree_showidcard.php?agree=' + is_agree;
...
function get_json(){
	...
	getID("picture").style.background = "url("+picarr[0]['profile_icon']['src_url']+") no-repeat";
	getID("picture").title = picarr[0]['profile_icon']['explain'];
	getID("picture").innerHTML = picarr[0]['profile_icon']['title'];
	getID("picture").setAttribute("onmousedown", "send_jy_pv2('"+picarr[0]['profile_icon']['total_tag']+"');");
}
</script>
...
<style type="text/css">
.user_scroll_pic .scroll_pic #urer_srcoll_box .img_box .box{ width:108px; height:108px; background:#f7f7f7;border: 1px solid #dcdcdc;}
</style>
<!-- 登录弹出开始 -->
...
<script>var logo_url="http://images1.jyimg.com/w4/profile_new/i/logo.jpg";</script>
...
<li><a href="http://diary.jiayuan.com/" onclick="jy_head_function.click_pv('|head_navigation_diary|');" target="_blank">两性</a></li>-->
            <li><a href="http://caipiao.jiayuan.com/" onclick="jy_head_function.click_pv('|head_navigation_caipiao|');" target="_blank">彩票</a></li>
...
<!-- service pop  -->
<div id="em_kxby12" class="service_introduction" style="display:none;">原价<strong style="text-decoration:line-through;">1568</strong>元，现价<strong>498</strong>元，现在购买，赠送：12个月VIP会员+12个月聊天包月（价值300元）</div>
<div id="em_kxby06" class="service_introduction" style="display:none;"> 原价<strong style="text-decoration:line-through;">998</strong>元，现价<strong>398</strong>元， 现在购买，赠送：6个月VIP会员+ 6个月聊天包月（价值160元） </div>
<div id="em_kxby03" class="service_introduction" style="display:none">原价<strong style="text-decoration:line-through;">598</strong>元，现价<strong>298</strong>元， 现在购买，赠送：3个月VIP会员+ 3个月聊天包月（价值84元） </div>
<div id="em_kxby01" class="service_introduction" style="display:none"> 原价<strong style="text-decoration:line-through;">268</strong>元，现价<strong>198</strong>元， 现在购买，赠送：1个月VIP会员+ 1个月聊天包月（价值32元） </div>
<!-- service pop end -->
<div class="main e_clear">
	...
	<script type="text/javascript">
		getID('skin_link').style.display='none';	</script>
	</div>
	<!-- skin end -->
	<!--main_left start-->
	<div class="main_left">
	    	<div class="tips_sfz" style="display:none" id="tips_sfz" onmouseover="Showtips_sfz();" onmouseout="Hiddentips_sfz();">
            	<strong>见面出示身份证</strong>
                <p>选择第一次见面出示身份证，彰显诚信，赢得更多青睐，获得更多来信！<br><a href="http://www.jiayuan.com/parties/2010/id_card/" target="_blank">查看佳缘会员对“第一次见面时出示身份证”的投票结果&gt;&gt;</a><br><input name="" value="" onclick="set_agree(this);" type="checkbox">&nbsp;我同意第一次见面出示身份证</p>
            </div>
			<div class="nav e_clear">
					<p><a href="http://www.jiayuan.com/104159755?n=1" onmousedown="send_jy_pv2('|nextPersonV1|');">下一个我感兴趣的人&gt;&gt;</a></p>
					<ul class="e_clear">
							<li class="firston"><span><a href="javascript:;">基本信息</a></span></li>
							<li><span><a onclick="openWindow('','','http://www.jiayuan.com/usercp/photo_scyd_tc.php?tc_type=1&amp;touid=104159755',572,222);return false;" href="javascript:;" onmousedown="send_jy_pv2('|navPhotoV1|');">我的照片(6)</a></span></li>																					<li><span><a href="http://www.jiayuan.com/more_gift.php?uid=104159755&amp;fxly=cp-eexpress" target="_blank" onmousedown="send_jy_pv2('|navGiftV1|');">我的礼物(2)</a></span></li>					</ul>
			</div>
			<!--user_conent start-->
			<div class="user_conent e_clear">
					...
					<div class="user_left">
						...
						<div class="user_operation">
								<div class="user_pic">
																		<span class="head_label"> <a href="http://case.jiayuan.com/face/?s=0&amp;url=http://a1.jyimg.com/44/4b/ec534301f3a4a313b205115b3b71/ec534301f_avatar_p.jpg&amp;fr=profile&amp;sex=f" target="_blank">找像她的人</a> </span>									<a target="_blank" id="profile_avatar_scyd" onmousedown="send_jy_pv2('|avatarV1|')" href="javascript:;"><img src="../../resources/img/ec534301f_avatar_p.jpg"></a>
								</div> 
								<div class="fly_degrees">
						            <p><i></i><a href="javascript:;" onclick="openWindow('','','http://www.jiayuan.com/profile/reliable.php?uid=104159755',570,390);" onmousedown="send_jy_pv2('|1011197_0|122261858');">[靠谱度查询]</a></p>
						            <div class="fly_layer">TA靠谱吗？查一下！<a class="fly-close" href="javascript:;" onclick="this.parentNode.style.display='none'; return false;"></a></div>						        </div>
								<p class="user_id">佳缘ID：104159755</p>
								<ul>
																		<li><a href="javascript:openWindowById('open_commend',400);" onmousedown="send_jy_pv2('|sendToFriendV1|');"><img src="../../resources/img/operation_icon2.png">推荐给好友</a></li>
																		<li><a href="http://vip.jiayuan.com/signup.php" target="_blank" onmousedown="send_jy_pv2('U_wyzh')"><img src="../../resources/img/opera_vip.png">今天我征婚</a></li>
									<li class="last"><img src="../../resources/img/operation_icon6.png">最后登录时间：<p><a href="javascript:;" onclick=" openWindow('','','http://www.jiayuan.com/usercp/service/vip_tstc.php?type=1&amp;to_uid=104159755',600,358); " onmousedown="send_jy_pv2('|lastLoginV1|');">点击查看</a></p></li>
									 
									<li><a href="http://www.jiayuan.com/complain/inform_photo.php?uid=104159755" target="_blank"><img src="../../resources/img/operation_icon7.png">举报盗用名人照片</a></li>
						...
						<div class="user_gift e_clear">
							...
							<div class="gift_content" id="giftCon1">
																<ul class="e_clear">
																		<li>
										<div class="gift_title"><p>一起看贺岁片</p><p>魅力值20点</p></div>
										<div class=""><img src="../../resources/img/1354761689.gif" onclick="openWindow('','','http://gift.jiayuan.com/send_gift.php?uid=104159755&amp;gid=1077',610,610);" style="cursor:pointer" height="60" width="60"><span></span></div>
									</li>
																		<li>
										<div class="gift_title"><p>爱情储蓄罐</p><p>魅力值20点</p></div>
										<div class=""><img src="../../resources/img/1354764191.gif" onclick="openWindow('','','http://gift.jiayuan.com/send_gift.php?uid=104159755&amp;gid=1081',610,610);" style="cursor:pointer" height="60" width="60"><span></span></div>
									</li>
																	</ul>
															</div>
							<div class="gift_content" id="giftCon2" style="display:none;">
																<p class="gift_none"><a href="javascript:;" onclick="openWindow('','','http://gift.jiayuan.com/send_gift.php?uid=104159755',610,610);" onmousedown="send_jy_pv2('|buttonGiftUpV1|');"><img src="../../resources/img/wish_none.gif"></a></p>
								<p class="more e_clear"><font color="black">她还未来得及许愿，挑选礼物赢得好感吧！</font><a href="javascript:;" onclick="openWindow('','','http://gift.jiayuan.com/send_gift.php?uid=104159755',610,610);" onmousedown="send_jy_pv2('|buttonGiftUpV1|');">送礼物&gt;&gt;</a></p>
															</div>
						</div>
						
						<div class="user_gift e_clear">
						<style>.mapText{padding:8px 0 8px 5px; text-align:left; width:120px; margin:0 auto;}
                        .mapText a{color:#06f; text-decoration:underline;}
                        </style>
						<h2>
							我的地图						</h2>
                       <div class="gift_content" id="mapCon1">
                        	<div style="padding-left:5px; padding-top:5px; color:#666; margin-bottom:5px;">我还没标注位置</div>
                        								<a href="http://www.jiayuan.com/map/result.php?from=profile&amp;uid=104159755" target="_blank" onmousedown="send_jy_pv2('|220167_4|');"><img src="../../resources/img/inMap.gif"></a>
							                        </div>
						<div class="gift_content" id="mapCon2" style="display:none;">
							<p class="mapText"><a href="http://www.jiayuan.com/map/citydate/index.php?cid=" target="_blank" onmousedown="send_jy_pv2('|220341_22|');"></a></p>
							<p><a href="http://www.jiayuan.com/map/citydate/index.php?cid=" target="_blank" onmousedown="send_jy_pv2('|220341_21|');"><img src="../../resources/img/map_.jpg" alt="" height="100" width="120"></a></p>
                        </div>
												</div>
						...
						<div class="complaints">
							...
							<div class="complaints_content">
								...
								<a href="http://www.jiayuan.com/complain/?uid_hash=44ec534301f3a4a313b205115b3b714b&amp;old=1" target="_blank">请向网站投诉 &gt;&gt;</a>
							</div>
						</div>

						<style type="text/css">
	.jy-attention{ position: absolute;left: -1px; border: 1px solid #ccc; padding: 8px; width: 143px; }	
	.jy-attention h3{ font-weight: bold; text-align:left; font-size: 12px; line-height:1; color: #333; border-bottom: 1px solid #e5e5e5; padding-bottom: 7px; }
	.jy-attention .con{ padding-top: 10px; }
	.jy-attention .con .l{ float: left; margin-right: 8px;  }
	.jy-attention .con .r{ float: left; }
	.jy-attention .con .r-c{ display: none; position: absolute; left: 0px; top: 64px; width: 159px; background-color: #e1e2e6; text-align: center; padding-top: 8px; padding-bottom: 5px; }
	.jy-attention .con .r-c p{ color: #666; line-height:14px; padding-top: 5px; }
</style>
<div><h2>关注世纪佳缘</h2>
...
<!--         </div> -->
        <div class="r" id="weixin_r">
        	<img src="../../resources/img/wx.png" alt="" height="25" width="72">
        </div>
        <div class="r-c" id="weixin_r_c">
            	<img src="../../resources/img/er.png" alt="" height="147" width="147">
                <p>微信扫描</p>	
                <p>添加世纪佳缘官方微信</p>
        </div>	
    </div>
...
<script type="text/javascript">
			...
			jQuery(".jy-attention .r-c").hide();	
					...
					<div class="user_right">
						...
						<div class="my_information">
																<div class="charm e_clear" onclick="javascript:;" onmousedown="send_jy_pv2('|charmIndexV1|');">
									<table border="0" cellpadding="0" cellspacing="0">
										<tbody><tr>
											<td><p class="text"><a href="http://www.jiayuan.com/meilistar" target="_blank">101</a></p></td>
										</tr>
										<tr>
								...
								<style>
									.my_information h1 span{float:left;padding:0 22px;clear: none;}
									.my_information h1 span.liaotian_con{padding:10px 0 0;}
									.my_information h1 a.tk_zhuandi_btn{width:92px;height:31px;background:url(http://images1.jyimg.com/w4/msgapp/ems/i/tkzd_new.png) no-repeat;float:left;margin-top:3px;padding-left:0;}
									.tk_zhuandi_r{position:relative;float:left;width:1px;}
									.tk_zhuandi_msg{width:167px;height:104px;background:url(http://images1.jyimg.com/w4/msgapp/ems/i/tkzd_new_tc.png) no-repeat;position:absolute;top:-92px;left:75px;cursor:default;}
									.tk_zhuandi_close{cursor:pointer;position:absolute;top:3px;right:22px;width:20px;height:20px;}
								</style>
																<script type="text/javascript">
									//添加cookie
									...
									window.onload=function(){
										if(getCookie("tkzd_122261858") != 'happy'){
											...
											var cookies_time = ((24-now_hours)*3600-now_minutes*60-now_seconds)*1000;
											addCookie('tkzd_122261858', 'happy', cookies_time);
                                	...
                                	function close_tk_zhuangdi_tc(){
										getID('tk_zhuandi_msg').style.display = 'none';
																...
																<h1 class="e_clear" style="position:relative;"><span>Icey～豆豆</span>
								<div class="tk_zhuandi_r">&nbsp;
                                	<div class="tk_zhuandi_msg" id="tk_zhuandi_msg" style="display:none;"><div class="tk_zhuandi_close" onclick="close_tk_zhuangdi_tc();"></div></div>
                                </div>
																<a id="picture" href="http://www.jiayuan.com/parties/2012/dafuweng/" style="text-indent: -9999px; overflow: hidden; display: block; width: 32px; height: 32px; position: absolute; top: 8px; left: 0px; background: url(&quot;http://images1.jyimg.com/w4/parties/2012/dafuweng/i/shaizi.gif&quot;) no-repeat scroll 0% 0% transparent;" title="做大富翁！赢大奖！" target="_blank" onmousedown="send_jy_pv2('|1003562_8|');">爱情大富翁</a>
								<a target="_blank" href="http://www.jiayuan.com/msgapp/ems/?uid_hash=44ec534301f3a4a313b205115b3b714b&amp;from=profile" class="tk_zhuandi_btn"></a>								</h1>
								...
								<dl class="e_clear">
									...
									<dd>
										<ul id="levellayer">
											<li>无，建议您优先联系提交过身份证明的会员</li>																																																																																								<li><a href="javascript:openWindow('','','http://www.jiayuan.com/about.php',560,610)">[说明]</a></li>
										</ul>
									</dd>
								</dl>
																<h2><a href="#detail" onmousedown="send_jy_pv2('|detailV1|');">查看详细信息&gt;&gt;</a>女，25岁，射手座，来自其他国家意大利</h2>
								<ul class="details">
									<li class="e_clear"><span class="w100"><b>身高：</b>165厘米</span><span class="w160"><b>学历：</b>硕士</span><span class="w100"><b>婚姻：</b>未婚</span><span class="w140"><b>月薪：</b>10000～20000元</span></li>
									<li class="e_clear"><span class="w100"><b>民族：</b>汉族</span><span class="w160"><b>职业：</b>设计/创意</span><span class="w100"><b>购车：</b>暂未购车</span><span class="w140"><b>住房：</b>独自租房</span></li>
								</ul>
								<!-- JiaThis Button BEGIN -->
								<div class="e_clear" id="share_box">
								<div id="ckepop" class="ckepop">
									<span class="jiathis_txt">分享：</span>
																		<span class="share_img" id="share_img"><img src="../../resources/img/share_new.gif"></span>
                                        ...
                                        <div class="tips_con">
                                            ...
                                            <p align="center"><a href="javascript:;" onclick="getID('share_tips').style.display='none';ajax('http://www.jiayuan.com/ajax/share_invite.php?uid=104159755','',function(data){ if(data==1){ openWindowById('open_share_invite'); setTimeout('closeWindowById(\'open_share_invite\')',5000);}else {getID('open_follow_error_text').innerHTML='参数错误';openWindowById('open_follow_error');}});;send_jy_pv2('|220235_1|');" class="btn_share">邀请分享</a></p>
                                            <p align="center"><a href="http://www.jiayuan.com/usercp/share.php?from=profile" target="_blank" onmousedown="send_jy_pv2('|220235_3|');">去设置我的分享</a></p>
                                        </div>
									...
									if(share_tips){
										share_img.onclick = function(){
											if(share_tips.style.display == 'none') share_tips.style.display = '';
											else share_tips.style.display = 'none'
										}
									} 
								</script>
																<!-- JiaThis Button END -->
								...
								<div class="user_scroll_pic e_clear">
									...
									<div class="scroll_pic w452" id="urer_srcoll">
										<ul id="urer_srcoll_box" style="overflow: hidden; width: 678px;">
																							<li>
												<div class="img_box"><div class="box">
																								<a onclick="openWindow('','','http://www.jiayuan.com/usercp/photo_scyd_tc.php?tc_type=1&amp;touid=104159755',572,222);return false;" href="javascript:;" onmousedown="send_jy_pv2('|photoThumbnailV1|');"><img style="max-width: 108px; max-height: 110px; top: 1px;" src="../../resources/img/96663128t.jpg" onload="makecenter(this);"></a>
																								</div></div></li>
																							<li>
												<div class="img_box"><div class="box">
																								<a onclick="openWindow('','','http://www.jiayuan.com/usercp/photo_scyd_tc.php?tc_type=1&amp;touid=104159755',572,222);return false;" href="javascript:;" onmousedown="send_jy_pv2('|photoThumbnailV1|');"><img style="max-width: 108px; max-height: 110px; top: 1px;" src="../../resources/img/96077907t.jpg" onload="makecenter(this);"></a>
																								</div></div></li>
																							<li>
												<div class="img_box"><div class="box">
																								<a onclick="openWindow('','','http://www.jiayuan.com/usercp/photo_scyd_tc.php?tc_type=1&amp;touid=104159755',572,222);return false;" href="javascript:;" onmousedown="send_jy_pv2('|photoThumbnailV1|');"><img style="max-width: 108px; max-height: 110px; top: 4px;" src="../../resources/img/95773839t.jpg" onload="makecenter(this);"></a>
																								</div></div></li>
																							<li>
												<div class="img_box"><div class="box">
																								<a onclick="openWindow('','','http://www.jiayuan.com/usercp/photo_scyd_tc.php?tc_type=1&amp;touid=104159755',572,222);return false;" href="javascript:;" onmousedown="send_jy_pv2('|photoThumbnailV1|');"><img style="max-width: 108px; max-height: 110px; top: 1px;" src="../../resources/img/95683314t.jpg" onload="makecenter(this);"></a>
																								</div></div></li>
																							<li>
												<div class="img_box"><div class="box">
																								<a onclick="openWindow('','','http://www.jiayuan.com/usercp/photo_scyd_tc.php?tc_type=1&amp;touid=104159755',572,222);return false;" href="javascript:;" onmousedown="send_jy_pv2('|photoThumbnailV1|');"><img style="max-width: 108px; max-height: 110px; top: 1px;" src="../../resources/img/95606480t.jpg" onload="makecenter(this);"></a>
																								</div></div></li>
																							<li>
												<div class="img_box"><div class="box">
																								<a onclick="openWindow('','','http://www.jiayuan.com/usercp/photo_scyd_tc.php?tc_type=1&amp;touid=104159755',572,222);return false;" href="javascript:;" onmousedown="send_jy_pv2('|photoThumbnailV1|');"><img style="max-width: 108px; max-height: 110px; top: 14.5px;" src="../../resources/img/95522911t.jpg" onload="makecenter(this);"></a>
																								</div></div></li>
																					</ul>
									</div>
									...
									<ul>
										...
										<li class="greet_btn"><a href="javascript:;" onclick="openWindow('','','http://www.jiayuan.com/msg/hello.php?type=20&amp;fxly=cp-eexpress&amp;src=none&amp;uhash=44ec534301f3a4a313b205115b3b714b&amp;cnj=profile2',612,600);" onmousedown="send_jy_pv2('|buttonGreetUpV1|');"></a></li>
						...
						<!--internal_monolog start-->
							...
							<div class="internal_monolog_content">
								<p>　　一句“我难受”可以换来谁的一句“你在哪？我马上到”</p>
												...
												<div class="claim">
							<h2><a href="http://www.jiayuan.com/paper/match/basic_match.php?uhash=44ec534301f3a4a313b205115b3b714b" target="_blank" onmousedown="send_jy_pv2('|matchV1|');">查看与我的匹配度&gt;&gt;</a>我的择友要求</h2>
						...
						<div class="hobbies claim">
							...
							<ul>
									...
									<li class="wirte_btn"><a onclick="window.open('http://www.jiayuan.com/msg/send.php?uhash=44ec534301f3a4a313b205115b3b714b&amp;fxly=cp-eexpress&amp;src=none&amp;cnj=profile3&amp;pre_url='+location.href)" href="javascript:;" onmousedown="send_jy_pv2('|buttonMailDownV1|');"></a></li>
																		<li class="greet_btn"><a href="javascript:;" onclick="openWindow('','','http://www.jiayuan.com/msg/hello.php?type=20&amp;fxly=cp-eexpress&amp;src=none&amp;uhash=44ec534301f3a4a313b205115b3b714b&amp;cnj=profile2',612,600);" onmousedown="send_jy_pv2('|buttonGreetDownV1');"></a></li>
																		<li class="gift_btn"><a href="javascript:;" onclick="openWindow('','','http://gift.jiayuan.com/send_gift.php?uid=104159755',610,610);" onmousedown="send_jy_pv2('|buttonGiftDownV1|');"></a></li>
									<li class="concern_btn"><a href="javascript:" onclick="ajax('http://www.jiayuan.com/follow.php?uid=104159755','',function(data){ if(data==1){ openWindowById('open_follow_success');}else if(data==-1){getID('open_follow_error_text').innerHTML='不能添加已在好友列表中的会员';openWindowById('open_follow_error');}else if(data==-2){getID('open_follow_error_text').innerHTML='不能添加在阻止名单中的会员';openWindowById('open_follow_error');}  else if(data==-3){getID('open_follow_error_text').innerHTML='不能添加相同性别的会员';openWindowById('open_follow_error');} else {getID('open_follow_error_text').innerHTML='参数错误';openWindowById('open_follow_error');}});" onmousedown="send_jy_pv2('|buttonAttentionDownV1|');"></a></li>
																	</ul>
						</div>
											</div>
					<!--user_right end-->
	...
	<div class="main_right">
			...
			<div class="mobile">
				...
				<div id="ad_pos_29"><div style="overflow:hidden;width:250;height:45;" id="jy_advert_91"><a href="http://www.jiayuan.com/advert/click.php?pos_id=29&amp;mr_id=926&amp;ad_id=83&amp;m_id=91&amp;userid=121261858&amp;ip=1951866301&amp;url=http://www.jiayuan.com/usercp/fate_express.php&amp;src_key=ad_3_29_83_91_926" target="_blank"><img src="../../resources/img/20130722032155599.gif" id="jy_advert_91_img" height="45" width="250"></a></div></div>
				</div>
			</div>
<!--  
			<div class="money">
...
<div id="ad_pos_11"><div id="jy_ad_513"><ul><li style="display: none;"><a href="http://www.jiayuan.com/advert/click.php?pos_id=11&amp;mr_id=6205&amp;ad_id=810&amp;m_id=513&amp;userid=121261858&amp;ip=1951866301&amp;url=http://www.jiayuan.com/parties/2012/dafuweng/index.php&amp;src_key=ad_3_11_810_513_6205" target="_blank"><img src="../../resources/img/20131219042940664.gif" alt=""></a></li><li style="display: none;"><a href="http://www.jiayuan.com/advert/click.php?pos_id=11&amp;mr_id=6206&amp;ad_id=810&amp;m_id=513&amp;userid=121261858&amp;ip=1951866301&amp;url=http://www.jiayuan.com/parties/2011/yjzq/&amp;src_key=ad_3_11_810_513_6206" target="_blank"><img src="../../resources/img/20140925045247943.jpg" alt=""></a></li><li style="display: block;"><a href="http://www.jiayuan.com/advert/click.php?pos_id=11&amp;mr_id=6207&amp;ad_id=810&amp;m_id=513&amp;userid=121261858&amp;ip=1951866301&amp;url=http://www.jiayuan.com/usercp/service/do_package_service.php?rid=70&amp;src_key=ad_3_11_810_513_6207" target="_blank"><img src="../../resources/img/20140925044902265.jpg" alt=""></a></li></ul></div></div>
		<!--VIP start-->
		    	<style>
		.myVipBd{padding:6px;}
			...
			.vipLeft{float:left; display:inline; padding:4px 0 0 6px; width:76px; height:76px; background-position:6px 4px; background-repeat:no-repeat;}
			...
			.vipBottom{text-align:center; padding-bottom:10px;}
			.vipBottom p{color:#666; line-height:40px;}
			.vipBottom p span{color:#ff7906; font-weight:bold;}
			.vipbtn{width:114px; height:25px; line-height:24px; font-size:14px; font-weight:bold; color:#fff; background:url(http://images1.jyimg.com/w4/profile_new/i/a1_07.png) no-repeat; display:inline-block;}
			 a.vipbtn{color:#fff;}
			 a.vipbtn:hover{text-decoration:none; color:#fff;}
			.vipbtn:hover{background:url(http://images1.jyimg.com/w4/profile_new/i/a1_10.png) no-repeat;}
			.ylsr .vipLeft{background-image:url(http://images1.jyimg.com/w4/profile_new/i/a1_12.png);}
			.kbkp .vipLeft{background-image:url(http://images1.jyimg.com/w4/profile_new/i/a1_03.png);}
			.kryb .vipLeft{background-image:url(http://images1.jyimg.com/w4/profile_new/i/a1_14.png);}
			.zwdt .vipLeft{background-image:url(http://images1.jyimg.com/w4/profile_new/i/a1_16.png);}
			.bxcg .vipLeft{background-image:url(http://images1.jyimg.com/w4/profile_new/i/a1_18.png);}
			.xlx .vipLeft{background-image:url(http://images1.jyimg.com/w4/profile_new/i/a1_20.png);}
			.xyyx .vipLeft{background-image:url(http://images1.jyimg.com/w4/profile_new/i/a1_22.png);}
			/*New Privilege*/
			.wkgs .vipLeft{background-image:url(http://images1.jyimg.com/w4/profile_new/i/a1_23.png);}
			.lszgw .vipLeft{background-image:url(http://images1.jyimg.com/w4/profile_new/i/a1_24.png);}
			.sgzw .vipLeft{background-image:url(http://images1.jyimg.com/w4/profile_new/i/a1_25.png);}
			.xjhhy .vipLeft{background-image:url(http://images1.jyimg.com/w4/profile_new/i/a1_26.png);}
			.yhtq .vipLeft{background-image:url(http://images1.jyimg.com/w4/profile_new/i/a1_27.png);}
			/*moblie*/
			...
			.moblieButton:link,.moblieButton:visited,.moblieButton:active{vertical-align:middle;margin-left:6px;background:#fb8c21 url(http://images1.jyimg.com/w4/profile_new/i/mobileButton.jpg) no-repeat 0 0;width:47px;height:25px;color:#fff;font:bold 14px/25px SimSun;display:inline-block;text-align:center;}
			.moblieButton:hover{text-decoration:none;color:#fff;}
		</style>

	    <div class="right_box mt10 lszgw">
	    	<h2>
	    		<a href="http://www.jiayuan.com/usercp/service/upgrade.php?from=menu&amp;src_key=profile_vip_more" onmousedown="send_jy_pv2('|1012817_5|');" target="_blank">全部23项特权&gt;&gt;</a>VIP会员
	    	</h2>
	        <div class="myVipBd">
				<div class="vipTop fn-clr">
					...
					<div class="vipRight">
						...
						<p>查看赞过我照片的人<br>了解谁对我有眼缘</p>
					</div>
				</div>
								<div class="vipBottom">
					<p>尝鲜VIP会员1个月 只需<span>16</span>元
					<a href="http://www.jiayuan.com/usercp/service/st_run.php?product_id=31&amp;src_key=profile_vip_B" class="vipbtn" target="_blank" onmousedown="send_jy_pv2('|1012817_4|');">马上激活特权</a>
	            </p></div>
	            	        </div>
	    </div>	
			...
			<div class="interested right_box mt10">
				<h2><a href="javascript:getInterestedMenbers();" onmousedown="send_jy_pv2('|InterestedV1|');">换一组</a>您可能感兴趣的人</h2>
				<div id="interested"><div class="ptb15"> 
	<ul class="e_clear"> 
		                <li><a href="http://www.jiayuan.com/85414802?src=personalmatch_profile_c&amp;fxly=tj-ymtj-grzlytj" target="_blank"><img src="../../resources/img/9735cfc8a_5_avatar_n.jpg" onmousedown="send_jy_pv2('|all_tag_m|122261858')" height="90" width="74"></a><a title="无聊的人" href="http://www.jiayuan.com/85414802?src=personalmatch_profile_c&amp;fxly=tj-ymtj-grzlytj" target="_blank" onmousedown="send_jy_pv2('|all_tag_m|122261858')"><p><i>无聊的人</i></p><p>25岁，其他国家</p></a>
		                		</li>
		                <li><a href="http://www.jiayuan.com/62474627?src=personalmatch_profile_c&amp;fxly=tj-ymtj-grzlytj" target="_blank"><img src="../../resources/img/dd6cb8cd0_4_avatar_n.jpg" onmousedown="send_jy_pv2('|all_tag_m|122261858')" height="90" width="74"></a><a title="佳缘用户" href="http://www.jiayuan.com/62474627?src=personalmatch_profile_c&amp;fxly=tj-ymtj-grzlytj" target="_blank" onmousedown="send_jy_pv2('|all_tag_m|122261858')"><p><img src="../../resources/img/diamond_icon.png" title="钻石会员"><i>佳缘用户</i></p><p>23岁，其他国家</p></a>
		                		</li>
		                <li><a href="http://www.jiayuan.com/28186251?src=personalmatch_profile_c&amp;fxly=tj-ymtj-grzlytj" target="_blank"><img src="../../resources/img/xjhykj_f_n.jpg" onmousedown="send_jy_pv2('|all_tag_m|122261858')" height="90" width="74"></a><a title="纳兰瑾萱" href="http://www.jiayuan.com/28186251?src=personalmatch_profile_c&amp;fxly=tj-ymtj-grzlytj" target="_blank" onmousedown="send_jy_pv2('|all_tag_m|122261858')"><p><i>纳兰瑾萱</i></p><p>27岁，其他国家</p></a>
		                		</li>
		                <li><a href="http://www.jiayuan.com/121748899?src=personalmatch_profile_c&amp;fxly=tj-ymtj-grzlytj" target="_blank"><img src="../../resources/img/yzphykj_f_n.jpg" onmousedown="send_jy_pv2('|all_tag_m|122261858')" height="90" width="74"></a><a title="peiwen" href="http://www.jiayuan.com/121748899?src=personalmatch_profile_c&amp;fxly=tj-ymtj-grzlytj" target="_blank" onmousedown="send_jy_pv2('|all_tag_m|122261858')"><p><img src="../../resources/img/diamond_icon.png" title="钻石会员"><i>peiwen</i></p><p>22岁，其他国家</p></a>
		                		</li>
		                <li><a href="http://www.jiayuan.com/118274292?src=personalmatch_profile_c&amp;fxly=tj-ymtj-grzlytj" target="_blank"><img src="../../resources/img/42669b904_5_avatar_n.jpg" onmousedown="send_jy_pv2('|all_tag_m|122261858')" height="90" width="74"></a><a title="炸炸" href="http://www.jiayuan.com/118274292?src=personalmatch_profile_c&amp;fxly=tj-ymtj-grzlytj" target="_blank" onmousedown="send_jy_pv2('|all_tag_m|122261858')"><p><i>炸炸</i></p><p>25岁，其他国家</p></a>
		                		</li>
		                <li><a href="http://www.jiayuan.com/43871464?src=personalmatch_profile_c&amp;fxly=tj-ymtj-grzlytj" target="_blank"><img src="../../resources/img/4d5fd19bc_avatar_n.jpg" onmousedown="send_jy_pv2('|all_tag_m|122261858')" height="90" width="74"></a><a title="bohany" href="http://www.jiayuan.com/43871464?src=personalmatch_profile_c&amp;fxly=tj-ymtj-grzlytj" target="_blank" onmousedown="send_jy_pv2('|all_tag_m|122261858')"><p><i>bohany</i></p><p>26岁，其他国家</p></a>
		                		</li>
			</ul>
</div></div>
			</div>
			<!--interested end-->
				...
				<div class="recommended_gift right_box mt10">
					<h2><a href="javascript:getCommendGift(104159755);" onmousedown="send_jy_pv2('|InterestedV1|');">换一组</a>礼物推荐</h2>
					<div class="" id="gift_commend">					<ul class="e_clear">
						<li class="list">
							<div class="gift_title"><p>二人世界</p><p>魅力值30点</p></div>
							<div class="" onmouseover="if(typeof(t1)!='undefined') clearTimeout(t1);showById('tips_left');if(typeof(t2)!='undefined'){ clearTimeout(t2);hiddenById('tips_right')}" onmouseout="t1=setTimeout('hiddenById(\'tips_left\')',1000);"><a href="javascript:;" onclick="openWindow('','','http://gift.jiayuan.com/send_gift.php?uid=104159755&amp;gid=106',610,300);" onmousedown="send_jy_pv2('|charmIndexV1|');"><img src="../../resources/img/1305609743.gif"></a><div class="mall_tips" id="tips_left">赠送礼物，可免费发信哦！<br>[<a href="http://gift.jiayuan.com/" target="_blank">更多礼物</a>]
</div><span></span></div>
							<p>二人世界</p>
							<p class="price">3张佳缘邮票</p>
							<a href="javascript:;" onclick="openWindow('','','http://gift.jiayuan.com/send_gift.php?uid=104159755&amp;gid=106',610,300);" class="handsel_btn" onmousedown="send_jy_pv2('|sendRecGiftV1|');"></a>
							<a href="javascript:;" onclick="openWindow('','','http://gift.jiayuan.com/send_gift.php?gid=106&amp;dowish=1',407,220);" class="favorites_btn" onmousedown="send_jy_pv2('|collectRecGiftV1|');"></a>
						</li>
						<li>
							<div class="gift_title"><p>爱之花</p><p>魅力值20点</p></div>
							<div class="" onmouseover="if(typeof(t2)!='undefined') clearTimeout(t2);showById('tips_right');if(typeof(t1)!='undefined'){ clearTimeout(t1);hiddenById('tips_left')}" onmouseout="t2=setTimeout('hiddenById(\'tips_right\')',1000);"><a href="javascript:;" onclick="openWindow('','','http://gift.jiayuan.com/send_gift.php?uid=104159755&amp;gid=222',610,300);" onmousedown="send_jy_pv2('|charmIndexV1|');"><img src="../../resources/img/1305620326.gif"></a><div class="mall_tips" id="tips_right">赠送礼物，可免费发信哦！<br>[<a href="http://gift.jiayuan.com/" target="_blank">更多礼物</a>]
</div><span></span></div>
							<p>爱之花</p>
							<p class="price">2张佳缘邮票</p>
							<a href="javascript:;" onclick="openWindow('','','http://gift.jiayuan.com/send_gift.php?uid=104159755&amp;gid=222',610,300);" class="handsel_btn" onmousedown="send_jy_pv2('|sendRecGiftV1|');"></a>
							<a href="javascript:;" onclick="openWindow('','','http://gift.jiayuan.com/send_gift.php?gid=222&amp;dowish=1',407,220);" class="favorites_btn" onmousedown="send_jy_pv2('|collectRecGiftV1|');"></a>
						</li>
					</ul></div>
				</div>
				<!--recommended_gift end-->
								<!--fate start-->
				<div id="ad_pos_52"><div class="myServiceBoxdiv right_box mt10"><h2 class="fuwubanTitle">推荐服务</h2><div class="myServiceBoxdivBody"><div class="myServiceTitle zhuanshi"><a href="http://www.jiayuan.com/usercp/service/bmsg_tg2.php?src_key=recommend_txt" target="_blank" class="more" style="margin-right:8px;">了解更多&gt;&gt;</a></div><div class="myServiceNR"><p>无限量免费看信，发信附邮票</p><p>包含VIP会员（共23项特权）</p><p>在线聊天，无需邀请</p></div><div class="buy_jiage"><ul><li><a href="http://www.jiayuan.com/advert/click.php?pos_id=52&amp;mr_id=5516&amp;ad_id=820&amp;m_id=551&amp;userid=121261858&amp;ip=1951866301&amp;url=http://www.jiayuan.com/usercp/service/do_package_service.php?rid=70&amp;src_key=ad_3_52_820_551_5516" class="zsRadius" target="_blank"><span class="condi1">12个月</span><span class="ssPink"><font color="#ff0066">已直减200元</font></span><span class="zs_open">开通</span><span class="ss2"><font color="#ff0033">￥</font><font class="mony" color="#ff0033">298</font></span></a></li><li><a href="http://www.jiayuan.com/advert/click.php?pos_id=52&amp;mr_id=5517&amp;ad_id=820&amp;m_id=551&amp;userid=121261858&amp;ip=1951866301&amp;url=http://www.jiayuan.com/usercp/service/dobmsg.php?pro_id=43&amp;src_key=ad_3_52_820_551_5517" class="zsRadius" target="_blank"><span class="condi1">6个月</span><span class="ssPink"></span><span class="zs_open">开通</span><span class="ss2">￥<font class="mony">398</font></span></a></li><li><a href="http://www.jiayuan.com/advert/click.php?pos_id=52&amp;mr_id=5518&amp;ad_id=820&amp;m_id=551&amp;userid=121261858&amp;ip=1951866301&amp;url=http://www.jiayuan.com/usercp/service/dobmsg.php?pro_id=41&amp;src_key=ad_3_52_820_551_5518" class="zsRadius" target="_blank"><span class="condi1">3个月</span><span class="ssPink"></span><span class="zs_open">开通</span><span class="ss2">￥<font class="mony">298</font></span></a></li><li><a href="http://www.jiayuan.com/advert/click.php?pos_id=52&amp;mr_id=5519&amp;ad_id=820&amp;m_id=551&amp;userid=121261858&amp;ip=1951866301&amp;url=http://www.jiayuan.com/usercp/service/dobmsg.php?pro_id=44&amp;src_key=ad_3_52_820_551_5519" class="zsRadius" target="_blank"><span class="condi1">1个月</span><span class="ssPink"></span><span class="zs_open">开通</span><span class="ss2">￥<font class="mony">198</font></span></a></li></ul></div></div></div></div>
				<!--fate end-->

				
				<!--recharge start-->
				<div class="recharge right_box mt10">
					<h2><a href="http://www.jiayuan.com/usercp/center/charge.php?src_key=mod_quickpay" target="_blank">更多支付方式</a>佳缘邮票快速充值</h2>
					<div class="recharge_content">
						<ul class="list e_clear">
								<li class="on" id="recharge1" onmouseover="tab('recharge','1','3')">网上银行</li><li id="recharge2" onmouseover="tab('recharge','2','3')">手机充值卡</li><li class="last" id="recharge3" onmouseover="tab('recharge','3','3')">支付宝</li>
						</ul>
						<div class="recharge_tab" id="rechargeCon1">
							<table width="222" cellpadding="0" cellspacing="0">
								<form action="http://www.jiayuan.com/usercp/center/bank_run.php?src_key=profile_quick_charge&amp;pid=2" method="POST" id="buy_gj_yinhang" name="buy_gj_yinhang" target="_blank"></form>
									<tbody><tr><td class="f600">邮票数量：<img src="../../resources/img/new_img1.jpg" onmouseover="showById('rechargelayer1')" onmouseout="hiddenById('rechargelayer1')"></td></tr>
									<tr><td>
										<label><input name="number" value="100" onclick="changecostyinhang('50','a');" type="radio">50张</label>
										<label><input name="number" checked="checked" value="200" onclick="changecostyinhang('100','a');" type="radio">100张</label>
										<label><input name="number" id="yinhang_youpiaocc" value="0" onclick="changecostyinhang('50','qita');" type="radio">其他</label>
										<input name="yinhang_youpiao1" id="yinhang_youpiao1" onclick="getID('yinhang_youpiaocc').checked = true;" onchange="check_form('yh');" onkeyup="changecostyinhang('50','qita');" size="5" class="other" style="text-indent:0px" type="text">张
										</td></tr>
									<tr><td class="f600">支付金额：<span id="cost_total_yinhang">200</span>元</td></tr>
									<tr><td class="f600">支付银行：<select name="bank"><option value="6" selected="selected">招商银行</option><option value="7">交通银行</option><option value="12">兴业银行</option><option value="1">中国工商银行</option><option value="10">上海浦东发展银行</option><option value="5">中国银行</option><option value="2">中国建设银行</option><option value="4">中国民生银行</option><option value="11">平安银行</option><option value="3">中国农业银行</option><option value="9">广东发展银行</option><option value="8">中国光大银行</option></select></td></tr>
									<input name="show_menu" value="1" type="hidden">
									<tr><td style="padding-top:5px;" align="center"><input class="next" onclick="if(typeof(send_jy_pv2)=='function'){ send_jy_pv2('profile_buy|yinhang|122261858');};getID('buy_gj_yinhang').submit();" type="button"></td></tr>
								
							</tbody></table>
							<!--recharge_layer start-->
							<div class="recharge_layer" id="rechargelayer1" style="display:none;">
								<div class="layer_box">
									<h2>充值流程</h2>
						...
						<div class="recharge_tab" id="rechargeCon2" style="display:none;">
							<table width="222" cellpadding="0" cellspacing="0">
								<form action="http://www.jiayuan.com/usercp/center/charge.php?src_key=mod_quickpay" method="POST" id="buy_gj_shouji" name="buy_gj_shouji" target="_blank"></form>
									<tbody><tr><td class="f600">充值卡种类：<img src="../../resources/img/new_img1.jpg" onmouseover="showById('rechargelayer2')" onmouseout="hiddenById('rechargelayer2')"></td></tr>
									<tr><td><label><input name="show_menu" value="3" checked="checked" type="radio"><span class="mobile">移动充值卡</span></label>&nbsp;&nbsp;<label class="label2"><input name="show_menu" value="10" type="radio"><span class="unicom">联通充值卡</span></label></td></tr>
									<tr><td class="f600">充值卡面额：</td></tr>
									<tr><td><label><input name="shouji_qian" value="50" type="radio">50元</label><label><input name="shouji_qian" checked="checked" value="100" type="radio">100元</label><label><input name="shouji_qian" value="300" type="radio">300元</label><label><input name="shouji_qian" value="500" type="radio">500元</label></td></tr>
									<tr><td class="f600">充值卡序列号：</td></tr>
									<tr><td><input name="shouji_kahao" class="text" onfocus="if(this.value=='全国卡、地方卡；苏/浙/闽/粤、易宝卡'){this.value='';this.style.color='#000';}" value="全国卡、地方卡；苏/浙/闽/粤、易宝卡" type="text"></td></tr>
									<tr><td class="f600">充值卡密码：</td></tr>
									<tr><td><input name="shouji_mima" class="text" value="输入后请认真核对密码" onfocus="if(this.value=='输入后请认真核对密码'){this.value='';this.style.color='#000';}" type="text"></td></tr>
									<tr><td style="padding-top:5px;" align="center"><input class="next" onclick="if(typeof(send_jy_pv2)=='function'){ send_jy_pv2('profile_buy|shouji|122261858');};getID('buy_gj_shouji').submit();" type="button"></td></tr>
								
							</tbody></table>
							<!--recharge_layer start-->
							<div class="recharge_layer" id="rechargelayer2" style="display:none;">
								<div class="layer_box">
									<h2>充值流程</h2>
									<div class="rechargelist">
										<ul>
												<li>1、选择充值卡种类、面额<br>输入充值卡序列号、密码</li>
												<li>2、点”下一步“进入支付中心</li>
						...
						<div class="recharge_tab" id="rechargeCon3" style="display:none;">
							<table width="222" cellpadding="0" cellspacing="0">
								<form action="http://www.jiayuan.com/usercp/center/charge.php?src_key=mod_quickpay" method="POST" id="buy_gj_zhifubao" name="buy_gj_zhifubao" target="_blank"></form>
									<tbody><tr><td class="f600">邮票数量：<img src="../../resources/img/new_img1.jpg" onmouseover="showById('rechargelayer3')" onmouseout="hiddenById('rechargelayer3')"></td></tr>
									<tr><td><label><input name="zhifubao_youpiao" value="24" onclick="changecostzhifubao('24','a');" type="radio">24张</label><label><input name="zhifubao_youpiao" checked="checked" value="49" onclick="changecostzhifubao('49','a');" type="radio">49张</label><label><input name="zhifubao_youpiao" id="zhifubao_youpiaocc" value="qita" onclick="changecostzhifubao('24','qita');" type="radio">其他</label><input name="zhifubao_youpiao2" class="youpiao" id="yinhang_zhifubao1" onchange="check_form('zfb');" onclick="getID('zhifubao_youpiaocc').checked = true;" onkeyup="changecostzhifubao('50','qita');" size="5" type="text">张</td></tr>
									<tr><td class="f600">支付金额：<span id="cost_total_zhifubao">98</span>元</td></tr>
									<input name="show_menu" value="2" type="hidden">
									<tr><td style="padding-top:5px;" align="center"><input class="next" onclick="if(typeof(send_jy_pv2)=='function'){ send_jy_pv2('profile_buy|zhifubao|122261858');};getID('buy_gj_zhifubao').submit();" type="button"></td></tr>
								
							</tbody></table>
							<!--recharge_layer start-->
							<div class="recharge_layer" id="rechargelayer3" style="display:none;">
								<div class="layer_box">
									<h2>充值流程</h2>
									<div class="rechargelist">
										<ul>
			...
			<div class="mobile mt10">
				<iframe src="../../resources/html/self_1_2_5.htm" scrolling="no" frameborder="0" height="70px" width="250px">
			</iframe>
			</div>
	</div>
</div>
...
<div id="ad_pos_2"><div id="jy_ad_714"><ul><li style="display: none;"><a href="http://www.jiayuan.com/advert/click.php?pos_id=2&amp;mr_id=6166&amp;ad_id=3&amp;m_id=714&amp;userid=121261858&amp;ip=1951866301&amp;url=http://www.jiayuan.com/advert/click.php?pos_id=2&amp;mr_id=6167&amp;ad_id=3&amp;m_id=714&amp;userid=121261858&amp;ip=1951866301&amp;url=http://www.jiayuan.com/club/draw.php&amp;src_key=ad_3_2_3_714_6167&amp;src_key=ad_3_2_3_714_6166" target="_blank"><img src="../../resources/img/20140923060917422.jpg" alt=""></a></li><li style="display: none;"><a href="http://www.jiayuan.com/advert/click.php?pos_id=2&amp;mr_id=6166&amp;ad_id=3&amp;m_id=714&amp;userid=121261858&amp;ip=1951866301&amp;url=http://www.jiayuan.com/advert/click.php?pos_id=2&amp;mr_id=6167&amp;ad_id=3&amp;m_id=714&amp;userid=121261858&amp;ip=1951866301&amp;url=http://www.jiayuan.com/club/draw.php&amp;src_key=ad_3_2_3_714_6167&amp;src_key=ad_3_2_3_714_6166" target="_blank"><img src="../../resources/img/20140923060917422.jpg" alt=""></a></li><li style="display: block;"><a href="http://www.jiayuan.com/advert/click.php?pos_id=2&amp;mr_id=6168&amp;ad_id=3&amp;m_id=714&amp;userid=121261858&amp;ip=1951866301&amp;url=http://www.jiayuan.com/wenda/subject.php?fr=ad&amp;src_key=ad_3_2_3_714_6168" target="_blank"><img src="../../resources/img/wenda.jpg" alt=""></a></li></ul></div></div>
  </div>
</div>
<!-- 通栏广告 结束 -->
...
<div class="layer" id="open_follow_success" style="display:none;">
	<div class="layer_box">
		<h2><img src="../../resources/img/op_but_close.gif" onclick="closeWindowById('open_follow_success')">关注成功</h2>
		<div class="friends_layer">
			<h3>你成功的关注了Icey～豆豆</h3>
			<p>你可以在<a href="http://www.jiayuan.com/usercp/friends.php">关注与联系人</a>中找到她</p>
			<p><a href="http://www.jiayuan.com/usercp/friends_new.php" target="_blank" style="margin-left:0px;">设置上线提醒</a>,短信通知不错过联系她的任何机会</p>
			<p>有好感？马上联系她吧！</p>
		</div>
		<div class="operation_btn pb20">
			<ul>
				<li class="wirte_btn"><a onclick="window.open('http://www.jiayuan.com/msg/send.php?uhash=44ec534301f3a4a313b205115b3b714b&amp;fxly=cp-eexpress&amp;src=none&amp;cnj=profile3&amp;pre_url='+location.href)" href="javascript:;"></a></li>
				<li class="greet_btn"><a href="javascript:;" onclick="closeWindowById('open_follow_success');openWindow('','','http://www.jiayuan.com/msg/hello.php?type=20&amp;fxly=cp-eexpress&amp;src=none&amp;uhash=44ec534301f3a4a313b205115b3b714b&amp;cnj=profile2',612,600);"></a></li>
				<li class="gift_btn"><a href="javascript:;" onclick="closeWindowById('open_follow_success');openWindow('','','http://gift.jiayuan.com/send_gift.php?uid=104159755',610,610);"></a></li>
			</ul>
		</div>
	</div>
</div>
<div class="layer" id="open_follow_error" style="display:none;">
	<div class="layer_box">
		<h2><img src="../../resources/img/op_but_close.gif" onclick="closeWindowById('open_follow_error')">关注好友失败</h2>
		<div class="friends_layer">
			<img src="../../resources/img/warn_icon.jpg">&nbsp;&nbsp;&nbsp;<span id="open_follow_error_text"></span>
		</div>
		<div class="operation_btn pb20">
			<ul>
				<li class="fixed_btn"><a href="javascript:closeWindowById('open_follow_error');"></a></li>
			</ul>
		</div>
	</div>
</div>
...
<div class="layer" id="open_invite_more" style="display:none;">
	<div class="layer_box">
		<h2><img src="../../resources/img/op_but_close.gif" onclick="closeWindowById('open_invite_more')"><span id="invite_pic_title">发送邀请成功</span></h2>
		<div class="friends_layer" style="text-align:center;padding: 15px 10px 15px 0px;">
			<span id="invite_pic_text">TA已经收到了你的邀请</span>
		</div>
		<div class="operation_btn pb20">
			<ul>
				<li class="fixed_btn"><a href="javascript:closeWindowById('open_invite_more');"></a></li>
			</ul>
		</div>
	</div>
</div>
...
<div class="layer" id="open_commend" style="display:none;">
	<div class="layer_box">
		<h2><img src="../../resources/img/op_but_close.gif" onclick="closeWindowById('open_commend')">将Icey～豆豆推荐给好友</h2>
		<div class="recommended_layer">
			<p class="c_e94684 f600">觉得Icey～豆豆不错，复制以下链接发送给好友吧！</p>
			<p><span>征友地址：</span><input value="http://www.jiayuan.com/104159755" type="text"></p>
		</div>
		<div class="operation_btn pb20">
			<ul>
				<li class="copy_btn"><a href="javascript:if(-[1,]){%20%20closeWindowById('open_commend');%20openWindowById('open_commend_error');%20}%20else{%20window.clipboardData.setData('text','http://www.jiayuan.com/104159755');closeWindowById('open_commend');openWindowById('open_commend_success');}"></a></li>
			</ul>
		</div>
	</div>
</div>
<div class="layer" id="open_commend_success" style="display:none;">
	<div class="layer_box">
		<h2><img src="../../resources/img/op_but_close.gif" onclick="closeWindowById('open_commend_success')">将Icey～豆豆推荐给好友</h2>
		<div class="recommended_layer">
			<p class="pt20"><img src="../../resources/img/success_icon.jpg">&nbsp;&nbsp;成功复制了Icey～豆豆的征友地址，您可以将地址通过QQ或MSN发送给朋友</p>
		</div>
		<div class="operation_btn pb20">
			<ul>
				<li class="fixed_btn"><a href="javascript:closeWindowById('open_commend_success')"></a></li>
			</ul>
		</div>
	</div>
</div>
<div class="layer" id="open_commend_error" style="display:none;">
	<div class="layer_box">
		<h2><img src="../../resources/img/op_but_close.gif" onclick="closeWindowById('open_commend_error')">将Icey～豆豆推荐给好友</h2>
		<div class="recommended_layer">
			<p class="pt20"><img src="../../resources/img/error_icon.jpg">&nbsp;&nbsp;对不起，当前浏览器暂不支持复制功能，请手动复制！</p>
			<p><span>征友地址：</span><input value="http://www.jiayuan.com/104159755" type="text"></p>
		</div>
		<div class="operation_btn pb20">
			<ul>
				<li class="fixed_btn"><a href="javascript:closeWindowById('open_commend_error')"></a></li>
			</ul>
		</div>
	</div>
</div>
...
<div class="layer" id="open_meili" style="display:none;">
	<div class="layer_box">
		<h2><img src="../../resources/img/op_but_close.gif" onclick="closeWindowById('open_meili')">温馨提示</h2>
		<div class="recommended_layer">
			<p class="pt20">
				您的诚意铸就TA的魅力，快去挑选一款最代表您诚意的礼物送给TA吧～
			</p>
		</div>
		<div class="operation_btn pb20">
			<ul>
				<li class="fixed_btn"><a onclick="closeWindowById('open_meili');openWindow('','','http://gift.jiayuan.com/send_gift.php?uid=104159755',610,610);" onmousedown="send_jy_pv2('|givenCharmV1|');" href="javascript:;"></a></li>
			</ul>
		</div>
	</div>
</div>
...
<!--弹出层 start-->
<div class="layer" id="open_window" style="top: 238.5px; left: 345.5px; width: 572px; display: none;">
	<div class="layer_box">
		<div style="display: none;" class="layer_title" id="open_window_head"><h2><img src="../../resources/img/op_but_close.gif" onclick="closeWindow()" title="关闭"><span id="open_window_title"></span></h2></div>
		<div class="layer_content" id="open_window_content"><iframe src="../../resources/html/photo_scyd_tc.htm" style="display: block;" id="open_window_iframe" scrolling="no" allowtransparency="true" frameborder="0" height="222" width="572"></iframe></div>
		<div id="iframe_loading" style="position: absolute; left: 182px; top: 101px; display: none;"><img id="loading_focus" src="../../resources/img/loading.gif"></div>
	</div>
</div>
<!--弹出层 end-->
...
<div class="layer" id="open_map" style="display:none;">
	<div class="map_layer">
		<div class="mapclose"><a href="javascript:;" onclick="closeWindowById('open_map')" class="close"></a><div class="clear"></div></div>
		<div class="mapiframe">
		  <iframe src="" scrolling="no" id="mapiframe" frameborder="0" height="263" width="494"></iframe>
		</div>
	    <div class="mapbotton"><a href="http://www.jiayuan.com/map/result.php?from=profile" target="_blank" onmousedown="send_jy_pv2('|220167_6|');"><img src="../../resources/img/mapbotton.jpg" border="0" height="41" width="138"></a></div>
	</div>
</div>
<!--我的地图 end-->
...
<div class="layer" id="open_vip" style="display:none;">
	<div class="layer_box">
		<h2><img src="../../resources/img/op_but_close.gif" onclick="closeWindowById('open_vip')">温馨提示</h2>
		<div class="recommended_layer">
			<p class="pt20">
				您还不是VIP会员，<a href="http://www.jiayuan.com/usercp/service/upgrade.php?from=skin" target="_blank">立即开通</a>尊享个性装扮，全部免费！			</p>
		</div>
		<div class="operation_btn pb20">
			<ul>
				<li class="fixed_btn"><a onclick="closeWindowById('open_vip'); window.open('http://www.jiayuan.com/usercp/service/upgrade.php?from=skin');" href="javascript:;"></a></li>
			</ul>
		</div>
	</div>
</div>
...
<div class="layer" id="open_share_invite" style="display:none;">
	<div class="layer_box">
		<h2><img src="../../resources/img/op_but_close.gif" onclick="closeWindowById('open_share_invite')">邀请成功</h2>
		<div class="min_layer">
			<h3>您的邀请已成功发送。<span>请耐心等待对方开通吧！</span></h3>
			<p><a onclick="closeWindowById('open_share_invite'); " onmousedown="" href="javascript:;">继续浏览该用户资料</a></p>
		</div>
	</div>
</div>
<!--邀请分享 start-->
...
function cutImage(){
	if(getID('urer_srcoll_box')){
		...
		for(var i= 0;i<objs.length;i++) setImage(objs.item(i));
	}
}
...
if(typeof loginWindow =="object"){
     loginWindow.set("config",{key:23,aid:0,callback:function(){
		location.reload();
	 }});
}
...
function orderService(){
	...
	if(pro_id != null){
		...
		window.open("http://www.jiayuan.com/usercp/service/dobmsg.php?src_key=recommend_form&pro_id=" + pro_id + "&jyyx=1&uid=");
	}
	else alert('请选择服务类型');
}
...
function order_service(name){
	...
	if(golddiamond_pid != null){
		send_jy_pv2('service_bmsg_jinzuan_' + golddiamond_pid +'|122261858');
		setYxCookie('gaoji_kanxin', golddiamond_pid);
		window.open("http://www.jiayuan.com/usercp/service/st_run.php?src_key=recommend_form&product_id=" + golddiamond_pid + "&jyyx=1&uid=122261858");
	}
	else alert('请选择服务类型');
}
...
var re = /现更名/g;
var aWorkLi = getByClass(document, 'work_life_content')[0].getElementsByTagName('li');
...
if(document.location.href.substring(document.location.href.length-7) == "#cp_kpd"){
	openWindow('','','http://www.jiayuan.com/profile/reliable.php?uid=104159755',570,380);
...
if(avatar_scyd){
		...
		avatar_scyd.onclick=function(){
				openWindow('','','http://www.jiayuan.com/usercp/photo_scyd_tc.php?tc_type=1&touid=104159755',572,222);
		return false;
			}
	}
</script>
<!-- footer -->
<div class="footer">
<script type="text/javascript" src="../../resources/js/profile_foot.js"></script>
