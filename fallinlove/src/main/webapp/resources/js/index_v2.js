            ...
            for(var i=0;i<data.length;i++)
            {
                ...
                if(type == "bigPhoto")
                {
                    ...
                    if($("#batch_hello").is(":hidden") && is_checked_exit(realUid) == 1)
                        userInfoHtml[i] = '<li style="z-index: 1;"><div class="hy_box hy_box_add2" onclick="dzhsingleSel(this,\'parent\');" onmouseover="userDivOver('+chatId+','+online+');" onmouseout="userDivOut('+chatId+','+online+')">'+face_div+randAttr+'<a  target="_blank" href="'+profileUrl+attachUrl+'"  class="openBox"><img src="'+data[i].image+'"></a></div><div class="user_name">'+data[i].userIcon+'<a target="_blank" title="'+data[i].nickname+'"  href="'+profileUrl+attachUrl+'">'+data[i].nickname+'</a></div> <p class="user_info">'+data[i].age+'岁 '+data[i].work_location+'</p><p class="zhufang">'+data[i].randTag+'</p><div class="zh_btn"><a href="javascript:void(0);" class="dzh" foo="1" ><span class="dzh_text1" onclick="show_hello_div_v2(\'\',\''+data[i].helloUrl+helloAttachUrl+'\');" style="display:none;">打招呼</span><span class="dzh_text2" style="display:block">已选</span><span class="dzh_text3 displayBlock" onclick="dzhCancle(this)">取消</span><span class="dzh_text4 dzh_add2"  style="display:none;">选择'+sexName+'</span></a><a id="chatbut_'+data[i].realUid+'"   href="#" class="lt" style="display:none;">聊天</a></div><div class="hy_box_bg"></div><div class="hy_box_bg2" style="display:block;"></div></div></li>';
                    else if($("#batch_hello").is(":hidden"))
                        userInfoHtml[i] = '<li style="z-index: 1;"><div class="hy_box hy_box_add" onclick="dzhsingleSel(this,\'parent\');" onmouseover="userDivOver('+chatId+','+online+');" onmouseout="userDivOut('+chatId+','+online+')">'+face_div+randAttr+'<a  target="_blank" href="'+profileUrl+attachUrl+'"  class="openBox"><img src="'+data[i].image+'"></a></div><div class="user_name">'+data[i].userIcon+'<a target="_blank" title="'+data[i].nickname+'"   href="'+profileUrl+attachUrl+'">'+data[i].nickname+'</a></div> <p class="user_info">'+data[i].age+'岁 '+data[i].work_location+'</p><p class="zhufang">'+data[i].randTag+'</p><div class="zh_btn"><a href="javascript:void(0);" class="dzh" foo="0" ><span class="dzh_text1" onclick="show_hello_div_v2(\'\',\''+data[i].helloUrl+helloAttachUrl+'\');" style="display:none;">打招呼</span><span class="dzh_text2">已选</span><span class="dzh_text3" onclick="dzhCancle(this)">取消</span><span class="dzh_text4 dzh_add2" onclick="dzhsingleSel(this,\'other\');"  style="display:block;">选择'+sexName+'</span></a><a id="chatbut_'+data[i].realUid+'"   href="#" class="lt" style="display:none;">聊天</a></div><div class="hy_box_bg"></div><div class="hy_box_bg2"></div></div></li>';
                    else
                        userInfoHtml[i] = '<li style="z-index: 1;"><div class="hy_box" onclick="dzhsingleSel(this,\'parent\');" onmouseover="userDivOver('+chatId+','+online+');" onmouseout="userDivOut('+chatId+','+online+')">'+face_div+randAttr+'<a  target="_blank" href="'+profileUrl+attachUrl+'"  class="openBox" onclick="profileClickCount('+isLogin+','+realPage+')"><img src="'+data[i].image+'"></a></div><div class="user_name">'+data[i].userIcon+'<a target="_blank" title="'+data[i].nickname+'"   href="'+profileUrl+attachUrl+'" onclick="profileClickCount('+isLogin+','+realPage+')">'+data[i].nickname+'</a></div> <p class="user_info">'+data[i].age+'岁 '+data[i].work_location+'</p><p class="zhufang">'+data[i].randTag+'</p><div class="zh_btn"><a href="javascript:void(0);"  class="dzh" foo="0" ><span class="dzh_text1" onclick="show_hello_div_v2(\'\',\''+data[i].helloUrl+helloAttachUrl+'\');">打招呼</span><span class="dzh_text2">已选</span><span class="dzh_text3" onclick="dzhCancle(this)">取消</span><span class="dzh_text4" onclick="dzhsingleSel(this,\'other\');">选择'+sexName+'</span></a><a id="chatbut_'+data[i].realUid+'"   href="javascript:openChatWindow('+data[i].realUid+',\''+data[i].sexValue+'\');" class="lt" style="display:none;">聊天</a></div><div class="hy_box_bg"></div><div class="hy_box_bg2"></div></div></li>';
...
function limitHelloUserCount(limitCount)
{
    ...
    {
        $("#show_this_page").removeAttr("checked");
        search_v2_alert("一次打招呼人数不能超过100人！");
        return false;
    }else
    {
        return 1;
...
function batSayHello()
{
    ...
    show_hello_div_v2('',say_hello_base_url+"/hello_bat.php?userId_str="+userId_str+"&fxly=seach_v2_pl");
}
function iniUserId()
{
...
//删除条件后搜索
var url_item_ids = {'dq':1,'nl':2,'sg':3,'hs':6,'xl':4,'zf':7,'ywzn':13,'gslx':15,'jg':9,'xx':18,'yx':5,'gc':8,'hkdq':10,'zy':14,'sx':16,'zjxy':12,'cxdj':22,'xz':17,'mz':11,'all':1000,'online':24,'new':27,'zp':23};
